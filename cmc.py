...
class CMC:
    """This implements Camera Motion Compensation (CMC) methods"""
    def __init__(self, method='orb', benchmark='MOT17', downscale=2, verbose=None):
        ...
        #     # file - the global motion compensation (GMC) technique used in the OpenCV implementation of the Video
        #     # Stabilization module with affine transformation. Refer for more on https://github.com/NirAharon/BoT-SORT
        #     seqName = verbose[0]
        #     ablation = verbose[1]
        #     if ablation:
        #         if self.benchmark == 'MOT17':
