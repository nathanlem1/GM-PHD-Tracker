...
class Identity(_BaseMetric):
    ...
    def eval_sequence(self, data):
        ...
        res['IDFN'] = fn_mat[match_rows, match_cols].sum().astype(int)  # np.int
        res['IDFP'] = fp_mat[match_rows, match_cols].sum().astype(int)  # np.int
        res['IDTP'] = (gt_id_count.sum() - res['IDFN']).astype(int)  # np.int
